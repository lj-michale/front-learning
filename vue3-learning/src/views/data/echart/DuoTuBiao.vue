<template>
  ...
  <div class="main">
    <div class="q-pa-sm1">
      ...
      <div class="col col4" ref="chart4">

      </div>
      <div class="col col5" ref="chart5">

      </div>
    </div>
    <div class="q-pa-sm2">
      <div class="col col1" ref="chart6">
...
onMounted(() => {
  ...
  myChart4.setOption(getChartSetOption4());
  myChart5 = echarts.init(chart5.value);
  myChart5.setOption(getChartSetOption5());
